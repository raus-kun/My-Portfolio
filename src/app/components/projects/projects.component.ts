...
export class ProjectsComponent {
  projects = [
    ...
    { name: 'My Portfolio', description: 'A personal portfolio showcasing my projects and skills.', tech: ['Angular', 'HTML', 'CSS','TypeScript'], github: 'https://github.com/raus-kun/My-Portfolio', live: '#' },
